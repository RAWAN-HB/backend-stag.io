...
// @route   POST /api/applications/:offerId
...
// Company accepts or rejects → if accepted, goes to pending_admin_approval
...
// Admin approves → status = accepted → convention auto-generated
...
const validateApplication = async (req, res) => {
  try {
    ...
    // If admin approves → auto-generate convention
    if (status === "accepted") {
